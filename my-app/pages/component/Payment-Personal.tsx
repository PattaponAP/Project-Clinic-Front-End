    ...
    return (
      <>
        ...
        <div className="flex justify-center space-x-8 items-center mt-4">
          ...
          {showBill && (
          <button onClick={handdlePrint} className="transition-all p-2 px-8 border border-black bg-[#042446] text-white rounded-xl shadow-xl hover:bg-white hover:text-black">
            พิมพ์ใบรับรองแพทย์
          </button>
          )}
        </div>
